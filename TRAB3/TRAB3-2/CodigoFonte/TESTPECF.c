...
*       1.00   JP   10/06/2019 Início do desenvolvimento
*
*  $ED Descrição do módulo
*     Este modulo contém as funções específicas para o teste do
*     módulo peça finalizada. Ilustra como redigir um interpretador de comandos
*     de teste específicos utilizando o arcabouço de teste para C.
*
*  $EIU Interface com o usuário pessoa
*     Comandos de teste específicos para testar o módulo peça:
*
*     "=criar"         - chama a função PECF_CriarPecaFinalizada( )
*     "=destroi"	   - chama a função PECF_ResetarPecaFinalizada( )
*     "=adicionar"     - chama a função PECF_AdicionaFinaliada( ) 
*     "=contar"        - chama a função PECF_ObterQuantidadeLisPF( ) e retorna 
...
***********************************************************************/
   ...
   } /* Fim função: PECF Efetuar operações de teste específicas para peca finalizada */
