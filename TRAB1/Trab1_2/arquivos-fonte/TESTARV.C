...
***********************************************************************/
   ...
   TST_tpCondRet TST_EfetuarComando( char * ComandoTeste )
   {
	  ...
	  /* Testar ARV Costura folhas da árvore */
		 ...
		 }/* fim ativa: Testar ARV Costura folhas da árvore */
		 
	  /* Testar ARV Exibe folhas da árvore */
         ...
         } /* fim ativa: Testar ARV Exiber folhas da árvore */
